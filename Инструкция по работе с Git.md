...
Для более детальной информации можно обратиться к [Справочным материалам по Markdown](https://learn.microsoft.com/ru-ru/contribute/markdown-reference), где находится алфавитный справочник по работе с Markdown для сайта Документации Microsoft.
